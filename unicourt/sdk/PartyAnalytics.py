...
class PartyAnalytics:
    ...
    def search_normalized_parties(
        ...
        ### Search for a party using a keyword expression. <br> **Note: A maximum of 15 operators are allowed in a single query.** <br> 
