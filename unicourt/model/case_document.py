...
class CaseDocument(BaseModel):
    ...
    source_data_status: Optional[StrictStr] = Field(default=None, description="The status of source data of document. If the sourceDataStatus is CURRENTLY_UNAVAILABLE_IN_COURT then it means that a particular document currently not available in the court site.", alias="sourceDataStatus")
